...
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/kiari_dashboard.PNG" width="680px" height="330px" title="px(픽셀) 크기 설정" alt="kiari dashboard"></img><br/>


- product webpage 접속량에 따른 kiari 대시보드 모니터링
- kiari dashboard - Graph의 namespace 포함    

<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/kiari_connection_confirm.PNG" width="840px" height="400px" title="px(픽셀) 크기 설정" alt="kiari conne"></img><br/>
