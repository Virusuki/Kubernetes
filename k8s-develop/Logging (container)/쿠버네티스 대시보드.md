...
- 쿠버네티스 대시보드 UI
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/kube_dashboard_UI.PNG" width="1050px" height="650px" title="px(픽셀) 크기 설정" alt="kubernetes dashboard Web UI"></img><br/>
