...
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/Jaeger_images/Jaeger_system.PNG" width="550px" height="350px" title="px(픽셀) 크기 설정" alt="Jaeger Architecture"></img><br/>
