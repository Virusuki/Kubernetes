...
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/dashboard_advance_button.PNG" width="1000px" height="750px" title="px(픽셀) 크기 설정" alt="kubernetes unsafe"></img><br/>


<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/token.PNG" width="800px" height="950px" title="px(픽셀) 크기 설정" alt="kubernetes unsafe"></img><br/>
