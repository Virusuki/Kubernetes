...
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/dashboard_advance_button.PNG" width="900px" height="550px" title="px(픽셀) 크기 설정" alt="kubernetes unsafe"></img><br/>


- token 버튼 클릭
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/token.PNG" width="900px" height="550px" title="px(픽셀) 크기 설정" alt="kubernetes unsafe"></img><br/>
