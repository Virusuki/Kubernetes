...
- Grafana 대시보드 검색된 번호
<img src="https://github.com/Virusuki/Kubernetes/blob/main/k8s-develop/Logging%20(container)/files/img/grafana_dashboard_search_number.PNG" width="400px" height="400px" title="px(픽셀) 크기 설정" alt="Prometheus URL"></img><br/>   
